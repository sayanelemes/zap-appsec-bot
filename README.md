...
* **🕷️ Быстрое сканирование (Fast Scan):**
  * Паук (Spider, глубина 2) + Активное сканирование параметров (SQLi, XSS, CSRF, RCE, IDOR и др.).
  * Тонкая настройка таймаутов ZAP (до 1 мин на правило, аварийный лимит 90 сек на активную фазу).
  * Параллелизация: до 10 потоков на хост.
